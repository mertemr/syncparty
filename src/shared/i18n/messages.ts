...
export const en = {
  ...
  "host.lobby.filesWaiting": "Someone still needs to open their copy of the film.",
  "host.lobby.filesMismatch": "Check the files before starting playback.",
  "host.lobby.peopleWaiting": "Everyone has the film; waiting for ready signals.",
  "host.lobby.everyoneReady": "Everyone has the same film open and is ready.",
